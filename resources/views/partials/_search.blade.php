<div class="max-w-screen-lg mx-auto rounded-md bg-white  px-4 relative -mt-12">
    ...
    <div class="relative">
        ...
        <input type="search"  class="block w-full p-6 pl-10 focus:outline-none text-sm text-gray-800 bg-white placeholder-neutral-500 dark:placeholder-neutral-400 dark:text-white" placeholder="Search Mockups, Logos...">
...
<button type="button" class="text-white bg-indigo-500 hover:bg-indigo-400 font-bold rounded-md px-6 py-2.5 focus:outline-none">Search</button>
</div>
</form>
