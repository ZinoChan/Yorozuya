<div class="max-w-screen-lg mx-auto rounded-md bg-white dark:bg-gray-800 px-4 relative -mt-12">
    ...
    <form action="/" class="flex justify-between items-center">
        ...
        <div class='flex items-center space-x-4 border-l border-gray-100 dark:border-gray-700 border-r px-4'>
            <span class="text-indigo-500 text-lg">
                <i class="fa-solid fa-location-dot"></i>
            </span>
            <select class="text-neutral-500 dark:text-gray-200 dark:placeholder:text-slate-200 focus:outline-none text-sm  block px-4 py-6 bg-transparent max-w-lg  ">
